        ...
        <div class="modal-body">
          <div class="form-row">
            <div class="form-group col-md-12">
              ...
              <input type="text" name="nama_shift" class="form-control" id="inputEmail4" required>
            </div>
            <div class="form-group col-md-12">
              <label for="inputEmail4">Waktu Mulai</label>
              <input type="time" name="waktu_mulai" class="form-control" id="inputEmail4" required>
            </div>
            <div class="form-group col-md-12">
              <label for="inputEmail4">Waktu Akhir</label>
              <input type="time" name="waktu_akhir" class="form-control" id="inputEmail4" required>
            </div>
          </div>
        </div>
        ...
        <form action="{{route('jamKerja.update', $dp->id)}}" method="post">
          ...
          <div class="modal-body">
            <div class="form-row">
              <div class="form-group col-md-12">
                <label for="inputEmail4">Nama Shift</label>
                <input type="text" name="nama_shift" value="{{$dp->nama_shift}}" class="form-control" id="inputEmail4" required>

                  <input type="hidden" name="id" value="{{$dp->id}}" class="form-control" id="inputEmail4" >
              </div>
              <div class="form-group col-md-12">
                <label for="inputEmail4">Waktu Mulai</label>
                <input type="time" name="waktu_mulai" value="{{$dp->waktu_mulai}}" class="form-control" id="inputEmail4" required>
              </div>
              <div class="form-group col-md-12">
                <label for="inputEmail4">waktu Akhir</label>
                <input type="time" name="waktu_akhir" value="{{$dp->waktu_akhir}}" class="form-control" id="inputEmail4" required>
              </div>
            </div>
          </div>
          <div class="modal-footer">
  ...
  <div class="list-data-karyawan">
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Data Jam Kerja</h1>
